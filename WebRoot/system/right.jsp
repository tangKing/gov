...
<input type="hidden" id="depId" value="${param.id}"/>
<div class="mod">
  <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="94%" valign="middle"><span class="STYLE1"> 部门配置</span></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
    ...
    <tr>
      ...
      <table class="formTable">
   	<tr>
   		<td width="15%">部门名称</td>
   		<td width="35%"><input type="text" name="depName" id="depName" style="width:98%"/></td>
   		<td width="15%">所属部门</td>
   		<td width="35%">
