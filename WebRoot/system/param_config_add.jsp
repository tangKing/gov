            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="94%" valign="middle"><span class="STYLE1">督办失效设置</span></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
    ...
    <tr>
      ...
      <table class="formTable">
   	<tr>
   		...
   		<td width="15%">失效时间</td>
   		<td width="35%">
   		<input type="text" name="endtime" id="endtime" style="width:98%"/>
   		</td>
   	</tr>
	<tr height="25">
	<td colspan="4" >
...
<script type="text/javascript" src="../js/param_config.js"></script>
</body>
</html>
