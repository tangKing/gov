  ...
  <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="94%" valign="middle"><span class="STYLE1">用户添加</span></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
    ...
    <tr>
      ...
      <table class="formTable">
   	<tr>
   		<td width="15%">用户名称</td>
   		<td width="35%"><input type="text" name="username" id="username" style="width:98%"/></td>
   		<td width="15%">真实姓名</td>
   		<td width="35%">
   		<input type="text" name="realname" id="realname" style="width:98%"/>
   		</td>
   	</tr>
   	<tr>
   	<td width="15%">密码</td>
   		<td width="35%"><input type="password" name="password" id="password" style="width:98%"/></td>
   		<td width="15%">确认密码</td>
   		<td width="35%">
   		<input type="password" name="repwd" id="repwd" style="width:98%"/>
   		</td></tr><tr>
   		<td width="15%">所属部门</td>
   		<td width="35%">
   		<select id="pName" name="pName" style="width:98%">
   			<option value="-1"></option>
   		</select></td>
   		<td width="15%">用户角色</td>
   		<td width="35%">
   		<select id="role" name="role" style="width:98%">
   			<option value="1">普通员工</option>
   			<option value="2">部门主管</option>
   			<option value="3">县长</option>
   		</select>
   		</td></tr>
	<tr height="25">
	<td colspan="4" >
