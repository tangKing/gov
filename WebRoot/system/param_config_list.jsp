          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 查看首页模块设置</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    ...
    <table  id="listTable" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()" style="text-align:center">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">失效内容</span></div></td>
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">失效时间</span></div></td>
      </tr>
    </table></td>
  </tr>
...
<script type="text/javascript" src="../js/paramConfigList.js"></script>
</body>
</html>
